...
:: Video ::
echo Encoding video...
".\programs\x264_x64" --threads auto --crf 20 --keyint 600 --ref 16 --no-fast-pskip --bframes 16 --b-adapt 2 --direct auto --me tesa --merange 64 --subme 11 --trellis 2 --partitions all --no-dct-decimate --profile high422 --output-csp i422 --range tv --input-range tv --colormatrix smpte170m -o ".\temp\video.h264" encode.avs
