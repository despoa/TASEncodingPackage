...
:: Video ::
".\programs\replacetext" "encode.avs" "i444 = false" "i444 = true"
".\programs\avs2pipemod" -y4mp encode.avs | ".\programs\x264_x86" --threads auto --sar "%VAR%" --crf 20 --keyint 600 --preset veryslow --input-range pc --range pc --tcfile-in ".\temp\times.txt" -o ".\temp\video_%ExtraScale%x.mkv" --colormatrix smpte170m --output-csp i444  --demuxer y4m -
:: Muxing ::
